    ...
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
          ...
          <div class="card-sub">已配对设备和实时连接。</div>
        </div>
    ...
    <section class="card">
      ...
      <div class="list" style="margin-top: 16px;">
        ...
        ${pending.length === 0 && paired.length === 0
          ? html`<div class="muted">暂无已配对设备。</div>`
          : nothing}
      </div>
    </section>
  `;
    ...
    <section class="card">
      ...
      ${state.formMode === "raw"
        ? html`<div class="callout warn" style="margin-top: 12px;">
            切换到配置页的<strong>表单</strong>模式来编辑绑定。
          </div>`
        : nothing}
            ...
            <div class="list" style="margin-top: 16px;">
              <div class="list-item">
                ...
                <div class="list-meta">
                  ...
                  ${!supportsBinding
                    ? html`<div class="muted">没有支持 system.run 的节点。</div>`
                    : nothing}
                </div>
              </div>
  ...
  return html`
    <div class="list" style="margin-top: 12px;">
      ...
      ${state.target === "node" && !hasNodes
        ? html`<div class="muted">暂无节点公告执行审批。</div>`
        : nothing}
    </div>
  `;
}
...
function renderExecApprovalsPolicy(state: ExecApprovalsState) {
  ...
  return html`
    <div class="list" style="margin-top: 16px;">
      ...
      <div class="list-item">
        <div class="list-main">
          <div class="list-title">自动允许技能命令行</div>
          <div class="list-sub">
            ${isDefaults
              ? "允许网关列出的技能可执行文件。"
              : autoIsDefault
...
function renderExecApprovalsAllowlist(state: ExecApprovalsState) {
  ...
  return html`
    ...
    <div class="list" style="margin-top: 12px;">
      ${entries.length === 0
        ? html`<div class="muted">暂无白名单条目。</div>`
